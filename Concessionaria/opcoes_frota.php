...
<fieldset>
    ...
    <ul>
        <?php foreach ($frotas as $frota): ?>
            <li><strong>Marca/Modelo:</strong> <?php echo $frota['marca_modelo']; ?> - <strong>Ano de Fabricação:</strong> <?php echo $frota['ano_fabricacao']; ?> 
            ...
            - <strong>Status:</strong> <?php echo $frota['status']; ?> - <strong>Observações:</strong> <?php echo $frota['observacoes']; ?></li>
        <?php endforeach; ?>
    </ul>
</fieldset>
